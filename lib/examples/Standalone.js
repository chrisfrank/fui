...
var backgrounds = ['AliceBlue', 'GhostWhite', 'WhiteSmoke', 'OldLace'];
var colors = ['#222', '#333', '#2a2a2a'];
  ...
  _createClass(StateExample, [{
    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        React.createElement(
          Panel,
          Object.assign({ bg: this.state.bg, color: this.state.color }, tree),
          React.createElement(
            'div',
            { style: style },
            React.createElement(
...
var Standalone = function Standalone() {
  return React.createElement(PanelTree, { render: function render(tree) {
